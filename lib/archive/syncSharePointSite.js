...
module.exports = async sharePointData => {
  ...
  if (getCase.CaseNumber) {
    ...
    const createCase = await callTemplateData('sharepoint', 'create-case', { caseTitle, projectNumber: result.projectNumber, caseExternalId, accessGroup, paragraph, responsiblePersonEmail: result.responsiblePersonEmail }) // Returns projectNumber from 360
